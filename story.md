# Story
This is my "story" section. I've decided to separate **indexing** and **story** to make things easier to navigate. Mostly made this to document my experience with each course I took, as well as provide a link to each one.

## Courses
### cursoemvideo
#### 1. [Python3](./cursoemvideo/python3)
- **ETC:** 120 hours
...
### freeCodeCamp
#### 2. [Responsive Web Design](./freecodecamp/01-responsive-web-design/)
- **ETC:** 50 hours
- **Language:** English (EN)
...
#### 3. [JavaScript Algorithms and Data Structures](./freecodecamp/02-javascript-algorithms-and-data-structures/)
- **ETC:** 80 hours
- **Language:** English (EN)
...
#### 4. [Front End Development Libraries](./freecodecamp/03-front-end-development-libraries/)
- **ETC:** 100 hours
- **Language:** English (EN)
...
### The Odin Project
#### 5. [Foundations](./theodinproject/01-foundations/)
- **ETC:** 200 hours
- **Language:** English (EN)
...
#### 6. [Full Stack JavaScript](./theodinproject/02-fullstackjavascript/)
- **ETC:** 600 ~ 1000 hours
- **Language:** English (EN)
